 ...
 */
final class Version20241211151039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medecin (id SERIAL NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, num_rpps BIGINT NOT NULL, num_tel BIGINT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE patient (id SERIAL NOT NULL, medecin_perso_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, num_secu_sociale VARCHAR(255) NOT NULL, num_tel BIGINT DEFAULT NULL, antecedent VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
